...
const Navbar = () => {
  ...
  const navOption = <>
    ...
    <li><Link to="founding"> Funding Page</Link></li>
  ...
  return (
    <div className="navbar bg-base-100 mx-auto fixed top-0 z-10 bg-opacity-30  text-green-700">
      ...
      </div>
      {
        isLoading ? (
          ...
          <div class="navbar-end">
            <div class="btn mr-10">
              <Link class="p-10" to="login">Login</Link>
            </div>
          </div>
